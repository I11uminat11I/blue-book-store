...
class PwdResetForm(PasswordResetForm):
    email = forms.EmailField(max_length=254, widget=forms.TextInput(attrs={'class': 'form-control mb-3', 'placeholder': 'Email',
    'id': 'form-email'}))
    ...
    def clean_email(self):
        ...
        if not u:
            raise forms.ValidationError('we cannot find that email')
        return email    
